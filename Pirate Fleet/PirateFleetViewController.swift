...
// TODO:Uncomment once PenaltyCell protocol has been implemented
            if penaltyCell.guaranteesHit {
                ...
                print("Guaranteed Hit by \(penaltyCell.type)")
            } else {
            ...
            // mine penalty
             if let penalty = penaltyCell as? Mine {
...
//                let alertMessage = (player.playerType == .human) ? Settings.Messages.HumanHitMine : Settings.Messages.ComputerHitMine
                ...
                if playerType == .human {
                    alertMessage = (penalty.guaranteesHit) ? Settings.Messages.HumanHitDamageMine : Settings.Messages.HumanHitMine
                } else {
                    alertMessage = (penalty.guaranteesHit) ? Settings.Messages.ComputerHitDamageMine : Settings.Messages.ComputerHitMine
                }
